    ...
    <div className="w-full relative grid grid-rows-[1fr_auto] text-[#03050a] py-[60px] h-screen">
      ...
      <AnimatePresence mode="wait">
        <motion.img
          ...
          className="w-[260px] top-[48%] -translate-y-1/2 left-[28%] absolute h-[360px] object-cover grayscale rotate-[-16deg]"
          alt="left"
        />
      </AnimatePresence>
      ...
      <AnimatePresence mode="wait">
        <motion.img
          ...
          exit={{ opacity: 0, x: 30 }}
          transition={{ duration: 0.5 }}
          className="w-[260px] top-[48%] -translate-y-1/2 right-[29%] absolute h-[360px] object-cover grayscale rotate-[16deg]"
          alt="right"
        />
      </AnimatePresence>
