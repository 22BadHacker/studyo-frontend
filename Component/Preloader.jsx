...
import JumpingCountdown from '@/Components/JumpingCountdown';
...
const [index, setIndex] = useState(0);
  ...
  return (
    <div className="absolute h-svh inset-0 z-[9999] bg-black flex items-center flex-col justify-center overflow-hidden">
        ...
        <div className="fixed w-screen h-screen flex-center mix-blend-difference  ">
          <Image alt='Logo' className='w-[55%]  mix-blend-difference' src={logo} width={140} height={140}/>

        </div>

        <div className="fixed   mix-blend-difference bottom-9 right-9">
            {/* <JumpingCountdown /> */}
