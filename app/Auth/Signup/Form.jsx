              ...
              <div className="flex w-full max-w-[90%] flex-col gap-6 pt-[70px]">
                ...
                <div className="flex items-center w-full justify-center gap-12">
                  ...
                  <div 
                    ...
                    className={`flex-center scale-[.98] w-[370px]  backdrop-blur-[50px] scale h-[280px]  rounded-lg border-[1px] flex flex-col gap-4 items-center cursor-pointer transition-all duration-200 ${
                      selectedRole === 'user' 
                        ? 'border-white/80 bg-white/10' 
                        : 'border-white/30 hover:bg-white/10 hover:border-white/60'
                    }`}
