    ...
    <>
      <div className="flex z-[50] fixed top-0 left-0 w-full py-6 px-10  items-center  justify-between l mx-auto">
        ...
        <div className="size-[48px] shadow-md bg-[#222222] rounded-full flex-center">
            {/* <img src="/Hand.jpg" alt="" className="size-[42px] rounded-full saturate-[1.3]  object-cover" />    */}
            {
