  ...
  return (
    <div className="min-h-screen pt-[190px] pb-[180px] ">
        <div className="container  flex flex-col gap-[30px] relative h-auto">
           ...
           <h1 className="text-[8vw] w-fit z-10 pb-[55px]  relative pt-5 text-[#d8262c] text-shadow-2xs text-shadow-[#d8262c] font-NeueMontreal font-bold uppercase leading-[.35] text-start">Trending Tracks <br />
              <div className="absolute z-[10] w-fit px-5 text-[12px] tracking-wide text-white flex-center text-shadow-2xs text-shadow-transparent rounded-full py-4.5 bg-gradient-to-r from-[#d8dfe8]/10 via-[#d8dfe8]/10 to-[#d8dfe8]/10 border border-white/10 backdrop-blur-[6px] scale-90  top-0 -rotate-8 font-medium capitalize left-1/2 -translate-x-1/2">to turn up the volume on.</div>
              <div className="absolute z-[10] w-fit px-4 text-[12px] tracking-wide text-white flex-center text-shadow-2xs text-shadow-transparent rounded-full py-4.5 bg-gradient-to-r from-[#d8dfe8]/10 via-[#d8dfe8]/10 to-[#d8dfe8]/10 border border-white/10 backdrop-blur-[6px] scale-90  bottom-6 -rotate-8 font-medium capitalize left-10">rising from the underground</div>
              <div className="absolute z-[10] w-fit px-4 text-[12px] tracking-wide text-white flex-center text-shadow-2xs text-shadow-transparent rounded-full py-4.5 bg-gradient-to-r from-[#d8dfe8]/10 via-[#d8dfe8]/10 to-[#d8dfe8]/10 border border-white/10 backdrop-blur-[6px] scale-90  bottom-6 -rotate-8 font-medium capitalize right-10">you can’t stop playing.</div>
           </h1>
           <img src="/xx.svg" alt="xx" className="absolute scale-95 mix-blend-screen saturate-150 -top-20 -right-1 rotate-6  object-cover" />
