  ...
  return (
    <>  
      ...
      <div className="">
        ...
        <div className="items-end  z-[10] pt-[180px] relative flex justify-between gap-4 w-full">
          <div className="flex  flex-col gap-2">
            <p className='flex  items-center  gap-2'><PiSealCheckThin className='text-[#4cb3ff] mb-[.2px] text-[28px]'/>Verified Artist</p>
